...
class SearchEvaluator:      
    ...
    def __init__(self, dataset_size, student_data_struct=None):
        ...
        self.BASE_PATH_TO_SOLUTION = join('solutions', 'search',
    ...
    def __read_solution(self):
        ...
        temp = df.drop(columns=['crypto_name'])
        return tuple(float(x) for x in temp.values[self.test_num]), df.iloc[self.test_num][['crypto_name']]
